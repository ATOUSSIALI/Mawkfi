...
const WelcomePage = () => {
  return <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background text-foreground">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          <Logo size="lg" />
          <h1 className="mt-4 text-2xl font-bold">Welcome to MAWKFI</h1>
        ...
        <div className="mt-8 space-y-4 animate-slide-up" style={{
        animationDelay: "0.4s"
      }}>
          <Link to="/login">
